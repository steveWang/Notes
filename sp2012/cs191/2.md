...
Our α_i are actually probability amplitudes. These don't sum to one; rather
the magnitudes of their intensities sum to one.
...
levels |j〉 with probability |α_j|² (i.e. you collapse the wave function).
...
that the summation of α_i² = 1. Our vector, therefore, must sit on the unit
k-sphere in k-space.
...
information. The fact that we are labeling our states as |0〉 and |1〉 is
indicative in itself that we are encoding information.
...
placed on the unit circle, we have |+〉 located at θ=π/4 and |-〉 located
at θ=-π/4.
...
[ explanation of Heisenberg's uncertainty principle, except without
  ...
  quantities, the more accurately you know one, the less accurately you can
  know the other. ]

[ maximal uncertainty occurs with conjugate basis. measure of uncertainty:
  spread -- |α₀| + |α₁|. Corresponds to maximum uncertainty. Uncertainty
  ranges from 1 to √2. ]

Specifically, Heisenberg's uncertainty principle: S(α₀) + S(β₀) ≥ √2. (α₀,
β₀ correspond to a conjugate basis)
