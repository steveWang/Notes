...
(function (TEX,HUB,AJAX) {
  ...
  var STACKITEM = STACK.Item = MathJax.Object.Subclass({
    ...
    Push: function () {return this.data.push.apply(this.data,arguments);},
    Pop: function () {return this.data.pop();},
    mmlData: function (inferred,forceRow) {
      if (inferred === null || inferred === undefined) {inferred = true;}
  ...
  STACKITEM.over = STACKITEM.Subclass({
    ...
    checkItem: function (item,stack) {
      ...
      if (item.isClose) {
        ...
        if (this.thickness !== null && this.thickness !== undefined) {mml.linethickness = this.thickness;}
...
//      noalign:            'HandleNoAlign',
  ...
  var PARSE = MathJax.Object.Subclass({
    ...
    Push: function () {return this.stack.Push.apply(this.stack,arguments);},
    mml: function () {
    ...
    ControlSequence: function (c) {
      ...
      else if (TEXDEF.delimiter["\\"+name] !== null && TEXDEF.delimiter["\\"+name] !== undefined) {this.csDelimiter(name,TEXDEF.delimiter["\\"+name]);}
    ...
    mi2mo: function (mi) {
      ...
      {if (mo.defaults.hasOwnProperty(id) && mi[id] !== null && mi[id] !== undefined) {mo[id] = mi[id];}}
      for (id in MML.copyAttributes)
      {if (MML.copyAttributes.hasOwnProperty(id) && mi[id] !== null && mi[id] !== undefined) {mo[id] = mi[id];}}
      return mo;
    },
    ...
    Color: function (name) {
      ...
      if (old) {return this.stack.env.color;} else {delete this.stack.env.color;}
      return this.Push(MML.mstyle(math).With({mathcolor: color}));
    },
    ...
    Macro: function (name,macro,argcount,def) {
      if (argcount) {
        ...
        if (def !== null && def !== undefined) {
          ...
          args.push(optional === null || optional === undefined ? def : optional);
        }
    ...
    Matrix: function (name,open,close,align,spacing,vspacing,style,cases) {
      ...
      if (align !== null && align !== undefined) {array.arraydef.columnalign = align;}
      this.Push(array);
    },
    ...
    HLine: function (name,style) {
      if (style === null || style === undefined) {style = "solid";}
      var top = this.stack.Top();
    ...
    */
    ...
    GetDelimiter: function (name) {
      ...
      if (this.i < this.string.length) {
        ...
        if (TEXDEF.delimiter[c] !== null && TEXDEF.delimiter[c] !== undefined) {return this.convertDelimiter(c);}
      }
    ...
    InternalMath: function (text,level) {
      var def = {displaystyle: false}; if (level !== null && level !== undefined) {def.scriptlevel = level;}
      if (this.stack.env.font) {def.mathvariant = this.stack.env.font;}
...
//        mml = MML.semantics(mml,MML.annotation(math).With({encoding:"application:x-tex"}));
    ...
    Error: function (message) {
      throw HUB.Insert(new Error(message),{texError: true});
    },
